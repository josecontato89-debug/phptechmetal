...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mb-4">
            ...
            <div class="card shadow border-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-house-check" viewBox="0 0 16 16">
  ...
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.707l.547.547 1.17-1.951a.5.5 0 1 1 .858.514"/>
                ...
                <div class="card-body">
                    ...
                    $listasetores = $consulta->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    if (count($listasetores) > 0) {
                        ...
                        foreach ($listasetores as $item) {
                            ...
                            echo "<td>" . htmlspecialchars($item['quant_funcionarios']) . "</td>";
                          ...
                          </svg></a> | <a href ='excluir_setores.php?id=$id'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill text-danger' viewBox='0 0 16 16'>
                        ...
                        echo "<p class='text-danger'><b>NÃO EXISTEM SETORES CADASTRADAS NO MOMENTO!</b></p>";
                    }
                    ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-hidden="true">
  ...
  <path d="M7.293 1.5a1 1 0 0 1 1.414 0L11 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l2.354 2.353a.5.5 0 0 1-.708.708L8 2.207l-5 5V13.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 2 13.5V8.207l-.646.647a.5.5 0 1 1-.708-.708z"/>
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.707l.547.547 1.17-1.951a.5.5 0 1 1 .858.514"/>
</svg>&nbsp; &nbsp; <h5 class="modal-title">CADASTRO DE SETORES</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body">
                <form action="cadastro_setores.php" method="POST">
                <label class="form-label">SETOR</label>
                <input type="text" name="setor" class="form-control" required/>
                <br/> 
                <label class="form-label">QUNTIDADE DE FUNCIONARIOS</label>
                <input type="number" name="quant_funcionarios" class="form-control" required/>
                <br/> 
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.707l.547.547 1.17-1.951a.5.5 0 1 1 .858.514"/>
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
           ...
           <div class="modal-body">
           <form action="editar_setores.php" method="POST">
            <input type="hidden" id="edit_id" name="id"/>
                ...
                <input type="number" name="quant_funcionarios" class="form-control" id="edit_quant_funcionarios" required/>
                <br/> 
...
<script>
    document.getElementById('modalEditar').addEventListener('show.bs.modal', function(event){
        ...
        fetch('buscar_setores.php?id=' +id)
           .then(response=>response.json())
           .then(data=>{
               document.getElementById('edit_id').value = data.id;
               document.getElementById('edit_setor').value = data.setor;
               document.getElementById('edit_quant_funcionarios').value = data.quant_funcionarios;
