...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mb-4">
            ...
            <div class="card shadow border-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-headset-vr" viewBox="0 0 16 16">
  ...
  <path d="M12 12a4 4 0 0 1-2.786-1.13l-.002-.002a1.6 1.6 0 0 0-.276-.167A2.2 2.2 0 0 0 8 10.5c-.414 0-.729.103-.935.201a1.6 1.6 0 0 0-.277.167l-.002.002A4 4 0 1 1 4 4h8a4 4 0 0 1 0 8"/>
                ...
                <div class="card-body">
                    ...
                    $listaequipamentos = $consulta->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    if (count($listaequipamentos) > 0) {
                        ...
                        foreach ($listaequipamentos as $item) {
                            ...
                            echo "<td>" . htmlspecialchars($item['objetivo']) . "</td>";
                          ...
                          </svg></a> | <a href ='excluir_equipamentos.php?id=$id'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill text-danger' viewBox='0 0 16 16'>
                        ...
                        echo "<p class='text-danger'><b>NÃO EXISTEM EQUIPAMENTOS CADASTRADOS NO MOMENTO!</b></p>";
                    }
                    ?>
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <path d="M12 12a4 4 0 0 1-2.786-1.13l-.002-.002a1.6 1.6 0 0 0-.276-.167A2.2 2.2 0 0 0 8 10.5c-.414 0-.729.103-.935.201a1.6 1.6 0 0 0-.277.167l-.002.002A4 4 0 1 1 4 4h8a4 4 0 0 1 0 8"/>
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
           ...
           <div class="modal-body">
           <form action="editar_equipamentos.php" method="POST">
            <input type="hidden" id="edit_id" name="id"/>
                ...
                <br/> 
                <label class="form-label">OBJETIVO</label>
                <input type="text" name="objetivo" class="form-control" id="edit_objetivo" required/>
                <br/> 
                <label class="form-label">QUANTIDADE</label>
                <input type="number" name="quantidade" class="form-control" id="edit_quantidade" required/>
                <br/>
...
<script>
    document.getElementById('modalEditar').addEventListener('show.bs.modal', function(event){
        ...
        fetch('buscar_equipamentos.php?id=' +id)
           .then(response=>response.json())
           .then(data=>{
               document.getElementById('edit_id').value = data.id;
               document.getElementById('edit_nome').value = data.nome;
               document.getElementById('edit_tipo').value = data.tipo;
               document.getElementById('edit_objetivo').value = data.objetivo;
