...
<div class="container">
  ...
  <path d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z"/>
                ...
                <div class="card-body">
                    ...
                    $sql = "SELECT * FROM operadores ORDER BY nome";
                    ...
                    if (count($listausuarios) > 0) {
                        ...
                        foreach ($listausuarios as $item) {
                          ...
                          </svg></a> | <a href ='excluir_operador.php?id=$id'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill text-danger' viewBox='0 0 16 16'>
                        ...
                        echo "<p class='text-danger'><b>NÃO EXISTEM OPERARIOS CADASTRADAS NO MOMENTO!</b></p>";
                    }
                    ?>
...
<script>
    document.getElementById('modalEditar').addEventListener('show.bs.modal', function(event){
        ...
        fetch('buscar_operadores.php?id=' +id)
